/*
  ...
  Palette: Brand blue (#1d4ed8) anchors trust. Canvas gray (#f8f9fb) feels like paper.
  Depth: Subtle single shadow on card — approachable but not playful.
    ...
    <div className="min-h-screen flex items-center justify-center bg-canvas px-4 py-12">
      ...
      <div className="w-full max-w-[420px] bg-surface rounded-lg shadow-card border border-edge">
        ...
        <div className="px-8 pt-8 pb-6 text-center border-b border-edge-subtle">
          {/* Logo placeholder — replace src with actual university logo */}
          ...
          <div className="flex items-center justify-between mb-6">
            <label className="flex items-center gap-2 text-sm text-ink-secondary cursor-pointer select-none">
              <input
                ...
                className="w-4 h-4 rounded border-control-border text-brand focus:ring-brand/30"
              />
              Remember me
            </label>
            <button
