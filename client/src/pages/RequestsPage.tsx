...
const MOCK_RECLAMATIONS = [
  {
    ...
    nom: 'Mehdaoui',
    prenom: 'Yacine',
    email: 'y.mehdaoui@univ-tiaret.dz',
    description: 'I believe there is an error in my Algorithms final exam grade. My calculated score based on the answer sheet should be 14/20, but the posted grade shows 09/20.',
    attachments: [{ name: 'Answer_Sheet_Photo.jpg', type: 'Image', size: '3.2 MB' }],
    timeline: [
      { event: 'Submitted', date: '2026-02-18', note: 'Request submitted with supporting documents.' },
      { event: 'Under Review', date: '2026-02-20', note: 'Forwarded to the examination committee.' },
    ],
  ...
  },
  {
    ...
    nom: 'Djeraba',
    prenom: 'Sara',
    email: 's.djeraba@univ-tiaret.dz',
    description: 'The TP grade posted for Organic Chemistry shows 06/20 but I attended all sessions and submitted all reports.',
    attachments: [{ name: 'TP_Reports_Scans.pdf', type: 'PDF', size: '5.4 MB' }],
    timeline: [
      { event: 'Submitted', date: '2026-02-16', note: 'Request submitted.' },
    ],
  ...
  },
  {
    ...
    nom: 'Bensalem',
    prenom: 'Amira',
    email: 'a.bensalem@univ-tiaret.dz',
    description: 'Database Systems and Software Engineering overlap on Sunday 10:00–11:30.',
    attachments: [{ name: 'Schedule_Screenshot.png', type: 'Image', size: '890 KB' }],
    timeline: [
      { event: 'Submitted', date: '2026-02-10', note: 'Request submitted.' },
      { event: 'Under Review', date: '2026-02-12', note: 'Reviewed by department.' },
      { event: 'Resolved — Approved', date: '2026-02-14', note: 'Group reassignment approved.' },
    ],
    linkedExam: null,
    adminResponse: { decision: 'approved', message: 'You have been reassigned to Group 3 for Software Engineering.' },
  },
];

/* ── Mock Data — Justifications ─────────────────────────────── */
...
const MOCK_JUSTIFICATIONS = [
  {
    ...
    nom: 'Zerhouni',
    prenom: 'Fatima',
    email: 'f.zerhouni@univ-tiaret.dz',
    description: 'I was unable to attend classes from February 17–19 due to a medical emergency.',
    attachments: [
      { name: 'Medical_Certificate.pdf', type: 'PDF', size: '420 KB' },
      { name: 'Hospital_Discharge.pdf', type: 'PDF', size: '1.1 MB' },
    ],
    timeline: [
      { event: 'Submitted', date: '2026-02-20', note: 'Submitted with medical documentation.' },
    ],
    linkedExam: null,
    adminResponse: null,
  },
  {
    ...
    nom: 'Benali',
    prenom: 'Khaled',
    email: 'k.benali@univ-tiaret.dz',
    description: 'I was absent from February 10–13 due to a family emergency in Oran.',
    attachments: [],
    timeline: [
      { event: 'Submitted', date: '2026-02-14', note: 'Submitted without documentation.' },
      { event: 'Resolved — Rejected', date: '2026-02-19', note: 'No supporting documents provided.' },
    ],
    linkedExam: null,
    adminResponse: { decision: 'rejected', message: 'No supporting documentation was provided. Please resubmit with official documents.' },
  },
  {
    id: 'JUS-2026-012',
    title: 'Absence Justification — Exam Overlap',
    category: 'justification',
    type: 'Academic',
    status: 'under-review',
    ...
    nom: 'Khelif',
    prenom: 'Mohamed',
    email: 'm.khelif@univ-tiaret.dz',
    description: 'I missed the make-up exam because it overlapped with another scheduled exam.',
    attachments: [{ name: 'Exam_Calendar.pdf', type: 'PDF', size: '280 KB' }],
    timeline: [
      { event: 'Submitted', date: '2026-02-12', note: 'Submitted with exam schedule.' },
      { event: 'Under Review', date: '2026-02-15', note: 'Being verified by the department.' },
    ],
    linkedExam: null,
    adminResponse: null,
  },
...
export default function RequestsPage({ role = 'student' }: { role?: string }) {
  ...
  const justifications = MOCK_JUSTIFICATIONS;
